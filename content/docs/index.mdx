...
<Cards>
  ...
  <Card title="了解 ByteHop" href="/docs/overview" description="理解 ByteHop 解决的问题、工作方式和核心设计。" />
...
<Callout title="v0.1 的产品重点">
  ByteHop 首版聚焦 HTTP 数据面、短期授权、凭证集中管理和可追踪的 Agent 调用。
</Callout>

下一步直接进入[第一次使用](./quickstart)，或者先阅读[产品介绍](./overview)。
